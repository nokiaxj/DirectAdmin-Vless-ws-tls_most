...
const UUID = (process.env.UUID || "ec08d1f4-aeda-49d1-875a-351d3f5bd355").trim();        // 替换"双引号中的UUID"
const DOMAIN = (process.env.DOMAIN || "most.jinca158.es.eu.org").trim();                    // 替换"双引号中的完整域名"
